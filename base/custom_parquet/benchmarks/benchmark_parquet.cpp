...
const String data_path = "/home/saber/dev/data/tpch/parquet/lineitem";
...
void testCustomParquet(int chunk_size, int type)
{
...
//        param.header.insert({date_type, "l_receiptdate"});
        ...
        if (type == 1)
        {
            param.active_columns = {0, 1, 2, 3,4,5,6};
        }
        else
        {
            param.active_columns = {1,2};
        }
